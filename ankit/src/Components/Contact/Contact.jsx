		...
		>
			<div className={styles.container}>
				...
				>
					...
					<a
						href='mailto: ankit8287670719@gmail.com'
						aria-label='email'
						target='_blank'
						rel='noreferrer'
					>
					...
					<a
						href='https://github.com/Ankitkumar-tech'
						aria-label='GitHub'
						rel='noreferrer'
						target='_blank'
					>
					...
					<a
						href='https://www.linkedin.com/in/ankit-kumar-037983199/'
						aria-label='Linkedin'
						target='_blank'
						rel='noreferrer'
					>
			...
			>
				Designed and build by Ankit Kumar, 2022 All rights
				reserved.
			</div>
		</footer>
	);
