...
const Home = ({ scrollRef }) => {
  const [projectArray, setProjectArray] = useState(projects.slice(0, 6));
      ...
      >
        ...
        >
          ...
          <div className={styles.btn}>
            <a
              href="https://drive.google.com/file/d/10IOB6jZ5xzXsrULzdTpZV0QCO2WtZYj1/view?usp=sharing" // Resume
              target="blank"
            >
              <Button
                text={
        ...
        >
          <img
            src="https://i.ibb.co/nBVsp1c/resume-image-2.jpg" //my Picture
            alt="Profile pic"
          />
        </div>
      </div>
